            ...
            if (t !== c) {
              if (
                ...
                i[t].parentNode.parentNode
                  ...
                  i[t].classList.add("filters__button--active");
              if (i[t].classList.contains("messages__contacts-tab"))
                i[t].parentNode.parentNode
                  .querySelector(".messages__contacts-tab--active")
                  .classList.remove("messages__contacts-tab--active"),
                  i[t].classList.add("messages__contacts-tab--active");
              c = t;
            }
          };
