                ...
                <div class="adding-post__tabs filters">
                    <ul class="adding-post__tabs-list filters__list tabs__list">
                        ...
                        <li class="adding-post__tabs-item filters__item">
                            <a class="adding-post__tabs-link filters__button filters__button-<?= mb_stristr($val['class_name'], '-'); ?> filters__button--active tabs__item tabs__item--active button" href="#">
